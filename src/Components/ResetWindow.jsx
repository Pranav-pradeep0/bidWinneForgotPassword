        ...
        <Box sx={{
            ...
            <Box sx={{
                ...
                <Box sx={{ display: 'grid', gap: '20px', }}>
                    ...
                    <Box sx={{display:'grid', gap:'10px'}}>
                        <Box>
                            <Typography sx={{ fontSize: '16px', fontWeight: '500', textAlign: 'start', marginBottom: '8px' }} variant=''>New Password</Typography>
                            <TextField sx={{ backgroundColor: 'white', borderRadius: '10px' }} fullWidth variant="outlined" />
                            <Typography sx={{fontSize:'11px', maxWidth:'350px', color:'rgba(0, 0, 0, 1)', opacity:'60%', marginTop:"5px"}}>Minimum 6 characters with combinations of upper and lowercase letters, numbers & symbols</Typography>
                        </Box>
                        <Box>
                            <Typography sx={{ fontSize: '16px', fontWeight: '500', textAlign: 'start', marginBottom: '8px' }} variant=''>Confirm Password</Typography>
                            <TextField sx={{ backgroundColor: 'white', borderRadius: '10px' }} fullWidth variant="outlined" />
                        </Box>
                    </Box>
                    <Link to={"/success"}>
